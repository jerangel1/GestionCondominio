...
import { getErrorMessage, Input, InputProps, inputVariants } from "./input";
...
const findObjectById = <T extends DEFAULT_OPTION>(
    ...
    const default_option = { id: 0, value: "=" } as T;
...
const SelectInput = <T extends DEFAULT_OPTION = DEFAULT_OPTION>({
    srOnly,
    errors,
    intent,
    size,
    ...
    return (
        <div
            ...
            className="w-full relative flex border  rounded-lg overflow-hidden"
        >
                ...
                <div
                    className={clsx(
                        ...
                        disabled || (data && data.length === 0)
                            ...
                            : "",
                        "rounded-none first:rounded-tl-lg last:rounded-bl-lg"
                    )}
                    aria-invalid={errors && name ? !!errorMessage : false}
                            ...
                            {memoizedItems.map((item, index) => (
                                <li
                                    className={clsx(
                                        ...
                                        "rounded-none first:rounded-tr-lg last:rounded-br-lg"
                                    )}
...
const SelectInputComponent = Object.assign(SelectInput, {
